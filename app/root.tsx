      ...
      <header className="remix-app__header">
        <div className="container remix-app__header-content">
          <Link to="/" title="Remix" className="remix-app__header-home-link">
            <img alt="Visnu Ghosh Experience Design Portfolio" src="/visnughosh_logo.png" />
          </Link>
          <nav aria-label="Main navigation" className="remix-app__header-nav">
            <ul>
              ...
              <li>
                <a href="https://www.linkedin.com/in/visnughosh/">LinkedIn</a>
              </li>
            </ul>
          </nav>
        </div>
        ...
        <div className="container remix-app__footer-content">
          ...
          <div style={{ display: 'flex' }}>
            <a
              ...
              href="/Visnu_Ghosh_Experience_Designer_Resume.pdf"
              target="_blank"
            >
            ...
            <a
              className="external_link"
              href="mailto:visnughosh@gmail.com"
              target="_blank"
            >
              <strong>visnughosh@gmail.com</strong>
            </a>
            <a
              className="external_link"
              href="https://www.linkedin.com/in/visnughosh/"
              target="_blank"
            >
              <strong>LinkedIn</strong>
            </a>
          </div>
          <h4>© VISNU GHOSH | 2021</h4>
        </div>
      </footer>
    </div>
  );
